...
export async function confirmSignUpAsync({ cognitoUser=null, showError=(e)=>console.log(e), setLoading=(e)=>console.log('loading set:',e), log='' }) {
    ...
    function doSuccess(log='') {
        console.log(log)
        setUnauthStatus({ log:"confirmCodeFormAsync error. "+log, keepUsername: true })
        showError(log)
        //resetStoredUserAuth()
        return true
    }  
    ...
    if (_cognitoUser === null) {
      return doFailure("ERROR ConfirmationCodeForm, confirmation code flow failure, also no cognitoUser" )
    }
    ...
    if (!resUsername) {
        return doFailure("ERROR ConfirmationCodeForm, cognitoUser username is null, returning early.." )
    }
    ...
    try {
        ...
        if (result === "SUCCESS") {
            ...
            return doSuccess("Your signup was successful and is confirmed." )
            ...
            return doFailure("There was a problem confirming the user" )
            ...
            case 'ExpiredCodeException':
                ...
                if (res === "submit") {
                    ...
                    try {
                        ...
                        return doFailure("New confirmation was sent" )
                        ...
                        return doFailure("Error requesting new confirmation code:", JSON.stringify(reqErr) )
                    }
                } 
                ...
                return doFailure("Confirmation code expired, request a new one." )

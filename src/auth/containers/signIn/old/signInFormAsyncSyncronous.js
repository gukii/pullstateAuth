  ...
  async function doSignIn({ username='', password='' }) {
    ...
    // called by the "SignInForm" function below
      ...
      try {
        ...
        // do this call with pullstate async+postActionHook!!!
        ...
        setLoading(false)
        window.alert('doSignIn caught:'+ JSON.stringify(e) )

        // ==> getting a code: "NetworkError" when using "dodoSignIn", but all works if using inline function async call...
        ...
        switch (e.code) {
          case 'UserNotConfirmedException':
              ...
              if (confirmed) {
                history.push(R.PRIVATE_HOME_ROUTE)
                return doSuccess(cognitoUser, "signInFormAsync, code confirmed")

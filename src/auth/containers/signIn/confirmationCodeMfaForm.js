...
*/
  ...
  React.useEffect( ()=> {
    ...
    if (mfaVerified) {
      ...
      setTimeout( () => {  return <Redirect to={R.AUTH_ROUTE} /> }, 3000);
    }

  }, [mfaVerified])

  ////  THIS FUNCTION IS NOT COMPLETE.. !!! CHECK 

  async function confirmMfaAsync({ username=null, code=null, setUnauthStatus, log='' }) {
